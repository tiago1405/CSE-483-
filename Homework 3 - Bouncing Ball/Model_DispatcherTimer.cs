...
namespace BouncingBall
{
    public partial class Model : INotifyPropertyChanged
    {
        ...
        // .NET Timer
        private DispatcherTimer _ballHiResTimer;
        private DispatcherTimer _paddelHiResTimer;
        ...
        public void InitModel()
        {
            ...
            _ballHiResTimer = new DispatcherTimer();
            _ballHiResTimer.Tick += new EventHandler(BallTimerCallback);
            _paddelHiResTimer = new DispatcherTimer();
            _paddelHiResTimer.Tick += new EventHandler(PaddelTimerCallback);

            // start timers
            _ballHiResTimer.Interval = new TimeSpan(0, 0, 0, 0, 1);
            _ballHiResTimer.Start();

            _paddelHiResTimer.Interval = new TimeSpan(0, 0, 0, 0, 1);
            _paddelHiResTimer.Start();
        }

        public void CleanUp()
        {
            _ballHiResTimer.Stop();
            _paddelHiResTimer.Stop();
        }
        ...
        private void PaddelTimerCallback(object obj, EventArgs ea)
        {
